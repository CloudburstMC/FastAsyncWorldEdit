...
//                                break;
//                            default: {
//                                BlockState block = CloudburstAdapter.asBlockState(hand);
//                                if (block != null) {
...
//            if (to.getLevel().equals(from.getLevel()) && to.getPosition().distanceSquared(from.getPosition()) < 8) {
...
//        com.sk89q.worldedit.entity.Player actor = CloudburstAdapter.adapt(plr);
...
//    }
//
//    private void sendBlockChange(Player player, BlockVector3 pt, BlockState block) {
//        Vector3i pos = Vector3i.from(pt.getX(), pt.getY(), pt.getZ());
//        org.cloudburstmc.server.block.BlockState state = CloudburstAdapter.adapt(block);
//        CloudBlock cloudBlock = new CloudBlock(player.getLevel(), pos, new org.cloudburstmc.server.block.BlockState[]{state, BlockStates.AIR});
//        player.getLevel().sendBlocks(new Player[]{player}, new Block[]{cloudBlock});
//    }
//
...
//        CloudburstPlayer cloudburstPlayer = CloudburstAdapter.adapt(player);
//        VirtualWorld vw = cloudburstPlayer.getSession().getVirtualWorld();
//        if (vw != null) {
//            return vw;
//        }
