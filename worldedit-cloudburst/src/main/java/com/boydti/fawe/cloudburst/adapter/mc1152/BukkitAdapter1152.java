package com.boydti.fawe.cloudburst.adapter.mc1152;
...
public final class BukkitAdapter1152 extends NMSAdapter {
    /*
    NMS fields
    */
    ...
    public static ChunkSection newChunkSection(final int layer, final Function<Integer, char[]> get, char[] set, boolean fastmode) {
        ...
        try {
            ...
            for (int i = 0; i < num_palette; i++) {
                ...
                final IBlockData ibd = ((BlockMaterial1152) state.getMaterial()).getState();
                palette.a(ibd);
            }
            try {
