...
public class AsyncBlock implements Block {
    ...
    public BlockData getBlockData() {
        return CloudburstAdapter.adapt(world.getBlock(x, y, z));
    }
    ...
    public void setBlockData(@NotNull BlockData blockData) {
        try {
            world.setBlock(x, y, z, CloudburstAdapter.adapt(blockData));
    ...
    public void setType(@NotNull Material type) {
        try {
            world.setBlock(x, y, z, CloudburstAdapter.asBlockType(type).getDefaultState());
        } catch (WorldEditException e) {
            throw new RuntimeException(e);
        }
    }
