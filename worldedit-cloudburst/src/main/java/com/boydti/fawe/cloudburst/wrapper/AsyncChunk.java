...
public class AsyncChunk implements Chunk {
    ...
    @Override
    public @NotNull AsyncWorld getWorld() {
        return world;
    }

    @Override
    public @NotNull AsyncBlock getBlock(int x, int y, int z) {
    ...
    @Override
    public boolean addPluginChunkTicket(final @NotNull Plugin plugin) {
        return world.addPluginChunkTicket(this.getX(), this.getZ(), plugin);
    }

    @Override
    public boolean removePluginChunkTicket(final @NotNull Plugin plugin) {
