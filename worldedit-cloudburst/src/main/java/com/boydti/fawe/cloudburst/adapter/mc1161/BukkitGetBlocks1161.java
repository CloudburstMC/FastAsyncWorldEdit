...
public class BukkitGetBlocks1161 extends CharGetBlocks {
    ...
    public BukkitGetBlocks1161(World world, int chunkX, int chunkZ) {
        this(((CraftWorld) world).getHandle(), chunkX, chunkZ);
    }

    public BukkitGetBlocks1161(WorldServer world, int chunkX, int chunkZ) {
        this.world = world;
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
    }
    ...
    public CompoundTag getTile(int x, int y, int z) {
        ...
        return new LazyCompoundTag1161(Suppliers.memoize(() -> tileEntity.save(new NBTTagCompound())));
    }
    ...
    public Chunk ensureLoaded(net.minecraft.server.v1_16_R1.World nmsWorld, int chunkX, int chunkZ) {
        return BukkitAdapter1161.ensureLoaded(nmsWorld, chunkX, chunkZ);
    }
    ...
    public synchronized char[] update(int layer, char[] data) {
        ...
        synchronized (lock) {
            ...
            try {
                FAWESpigotV116R1 adapter = ((FAWESpigotV116R1) WorldEditPlugin.getInstance().getAdapter());
