...
//
//public class CloudburstItemCategoryRegistry implements ItemCategoryRegistry {
//
//    private Set<ItemType> getFromBukkitTag(Tag<Material> tag) {
//        return tag.getValues().stream().map(CloudburstAdapter::asItemType).collect(Collectors.toSet());
//    }
//
//    @Override
