...
//
//public class CloudburstBlockCommandSender extends AbstractNonPlayerActor implements Locatable {
//
...
//
//    public CloudburstBlockCommandSender(WorldEditPlugin plugin, BlockCommandSender sender) {
//        checkNotNull(plugin);
//        checkNotNull(sender);
//
//        this.plugin = plugin;
//        this.sender = sender;
//        this.location = CloudburstAdapter.adapt(sender.getBlock().getLocation());
