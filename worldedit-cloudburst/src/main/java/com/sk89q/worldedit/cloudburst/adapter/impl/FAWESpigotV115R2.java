...
import com.boydti.fawe.cloudburst.adapter.mc1152.BlockMaterial1152;
import com.boydti.fawe.cloudburst.adapter.mc1152.BukkitAdapter1152;
import com.boydti.fawe.cloudburst.adapter.mc1152.FAWEWorldNativeAccess1152;
import com.boydti.fawe.cloudburst.adapter.mc1152.MapChunkUtil1152;
...
public final class FAWESpigotV115R2 extends CachedBukkitAdapter implements IDelegateBukkitImplAdapter<NBTBase> {
    ...
    private static net.minecraft.server.v1_15_R1.Block getBlockFromType(BlockType blockType) {
        return net.minecraft.server.v1_15_R1.IRegistry.BLOCK.get(net.minecraft.server.v1_15_R1.MinecraftKey
                                                                     .a(blockType.getId()));
    }

    private static Item getItemFromType(ItemType itemType) {
        return net.minecraft.server.v1_15_R1.IRegistry.ITEM.get(net.minecraft.server.v1_15_R1.MinecraftKey
                                                                    .a(itemType.getId()));
    }
