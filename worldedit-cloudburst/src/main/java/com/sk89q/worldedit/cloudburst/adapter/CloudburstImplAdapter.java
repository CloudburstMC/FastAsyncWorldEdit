 ...
 */
public interface CloudburstImplAdapter extends ICloudburstAdapter {
     ...
     * @return the block
     */
    BaseBlock getBlock(Vector3i location);
    ...
    default World createWorld(WorldCreator creator) {
        return ((FaweCloudburst) Fawe.imp()).createWorldUnloaded(creator::createWorld);
    }
     ...
     */
    default boolean regenerate(Level world, Region region, EditSession session) {
