...
//
//public class CloudburstBlockCategoryRegistry implements BlockCategoryRegistry {
//
//    private Set<BlockType> getFromBukkitTag(Tag<Material> tag) {
//        return tag.getValues().stream().map(CloudburstAdapter::asBlockType).collect(Collectors.toSet());
//    }
//
//    @Override
