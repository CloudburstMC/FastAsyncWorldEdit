...
class CloudburstCommandInspector implements CommandInspector {

    private static final Logger logger = LoggerFactory.getLogger(CloudburstCommandInspector.class);
    private final WorldEditPlugin plugin;
    private final CommandManager dispatcher;

    CloudburstCommandInspector(WorldEditPlugin plugin, CommandManager dispatcher) {
        checkNotNull(plugin);
