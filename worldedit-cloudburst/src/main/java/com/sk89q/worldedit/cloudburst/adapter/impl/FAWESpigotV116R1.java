...
package com.sk89q.worldedit.cloudburst.adapter.impl;

import com.boydti.fawe.Fawe;
import com.boydti.fawe.FaweCache;
import com.boydti.fawe.beta.IChunkGet;
import com.boydti.fawe.beta.implementation.packet.ChunkPacket;
import com.boydti.fawe.bukkit.adapter.mc1161.*;
import com.boydti.fawe.cloudburst.adapter.mc1161.BlockMaterial1161;
...
import com.boydti.fawe.cloudburst.adapter.mc1161.FAWEWorldNativeAccess1161;
...
import com.sk89q.worldedit.cloudburst.adapter.CachedBukkitAdapter;
import com.sk89q.worldedit.cloudburst.adapter.IDelegateBukkitImplAdapter;
...
public final class FAWESpigotV116R1 extends CachedBukkitAdapter
    implements IDelegateBukkitImplAdapter<NBTBase> {
    ...
    public FAWESpigotV116R1() throws NoSuchFieldException, NoSuchMethodException {
    ...
    private synchronized boolean init() {
        ...
        for (int i = 0; i < ibdToStateOrdinal.length; i++) {
            ...
            BlockMaterial1161 material = (BlockMaterial1161) state.getMaterial();
    ...
    public BlockMaterial getMaterial(BlockType blockType) {
        ...
        return new BlockMaterial1161(block);
    }

    @Override
    public BlockMaterial getMaterial(BlockState state) {
        IBlockData bs = ((CraftBlockData) Bukkit.createBlockData(state.getAsString())).getState();
        return new BlockMaterial1161(bs.getBlock(), bs);
    ...
    public BaseBlock getBlock(Location location) {
        ...
        BlockState state = CloudburstAdapter.adapt(bukkitBlock.getBlockData());
    ...
    public boolean setBlock(org.bukkit.Chunk chunk, int x, int y, int z, BlockStateHolder state, boolean update) {
        ...
        IBlockData blockData = ((BlockMaterial1161) state.getMaterial()).getState();
        ...
        IBlockData existing;
        if (section == null) {
            existing = ((BlockMaterial1161) BlockTypes.AIR.getDefaultState().getMaterial())
                .getState();
        } else {
        ...
        CompoundTag nativeTag = state instanceof BaseBlock ? ((BaseBlock) state).getNbtData() :
            null;
        if (nativeTag != null || existing instanceof TileEntityBlock) {
            ...
            if (nativeTag != null) {
                ...
                if (tileEntity != null) {
                    ...
                    tileEntity
                        .load(tileEntity.getBlock(), tag); // readTagIntoTileEntity - load data
                }
            }
        } else {
    ...
    public WorldNativeAccess<?, ?, ?> createWorldNativeAccess(org.bukkit.World world) {
        return new FAWEWorldNativeAccess1161(this, new WeakReference<>(((CraftWorld) world)
                                                                           .getHandle()));
    }
    ...
    public Component getRichItemName(BaseItemStack itemStack) {
        return TranslatableComponent.of(CraftItemStack.asNMSCopy(CloudburstAdapter.adapt(itemStack)).j());
    }
    ...
    private MapChunkUtil1161 mapUtil = new MapChunkUtil1161();

    @Override
    public void sendFakeChunk(org.bukkit.World world, Player player, ChunkPacket packet) {
        WorldServer nmsWorld = ((CraftWorld) world).getHandle();
        PlayerChunk map = BukkitAdapter1161
            .getPlayerChunk(nmsWorld, packet.getChunkX(), packet.getChunkZ());
        if (map != null && map.hasBeenLoaded()) {
            boolean flag = false;
            PlayerChunk.d players = map.players;
            Stream<EntityPlayer> stream = players
                .a(new ChunkCoordIntPair(packet.getChunkX(), packet.getChunkZ()), flag);
    ...
    public org.bukkit.inventory.ItemStack adapt(BaseItemStack item) {
        ItemStack stack = new ItemStack(IRegistry.ITEM
                                            .get(MinecraftKey.a(item.getType().getId())), item
                                            .getAmount());
    ...
    public BaseItemStack adapt(org.bukkit.inventory.ItemStack itemStack) {
        ...
        final BaseItemStack weStack = new BaseItemStack(CloudburstAdapter.asItemType(itemStack
                                                                                     .getType()), itemStack
                                                            .getAmount());
    ...
    public NBTBase fromNative(Tag foreign) {
        if (foreign instanceof LazyCompoundTag1161) {
            return ((LazyCompoundTag1161) foreign).get();
        }
    ...
    public boolean regenerate(org.bukkit.World world, Region region, EditSession editSession) {
        ...
        //                    extent.init(null, (x, z) -> new BukkitGetBlocks1161(freshWorld, x, z) {
        //                        @Override
    ...
    public IChunkGet get(org.bukkit.World world, int chunkX, int chunkZ) {
        return new BukkitGetBlocks1161(world, chunkX, chunkZ);
    }

    @Override
    public int getInternalBiomeId(BiomeType biome) {
        BiomeBase base = CraftBlock.biomeToBiomeBase(CloudburstAdapter.adapt(biome));
